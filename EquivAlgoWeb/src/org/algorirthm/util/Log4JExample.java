...
public class Log4JExample
{
  ...
  public static final Logger logger=Logger.getLogger(AlgorithmEngine.class);

  static final String LOG_PROPERTIES_FILE = "C:/eclipseProjects/TypeEquivFinal/sampleFiles/Log4J.properties";
